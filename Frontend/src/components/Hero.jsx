...
const Hero = () => {
  return (
    <section className="max-padd-container pt-[99px]">
      <div className="max-padd-container bg-hero bg-center bg-cover 
      bg-no-repeat h-[655px] w-full rounded-3xl">
        <div className="relative top-32 xs:top-52 ">
          <span className="medium-18">Welcome to CasaCentral</span>
          <h1 className="h1 capitalize max-w-[40rem]">Dicover Exceptional Homes With CasaCentral</h1>
          <p className="my-10 max-w-[33rem]">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Hic at
            iure exercitationem, rem harum eveniet amet dolorem sed suscipit
            cumque, inventore eos reiciendis tempora id tenetur, totam porro vel
            animi.
          </p>
          {/* button */}
